...
@RestController
@Slf4j
public class HttpsClientMutualAuth4Controller {

    @RequestMapping("/httpsMutualAuthByHttpClient41")
    public String httpsMutualAuthByHttpClient41() throws Exception {
        // 客户端p12证书
        String p12Path = "/certificates/client/ningbolaw.com.p12";
        // 客户端p12证书密码
        String p12Pwd = "123456";
        // url，需要使用域名访问，可在本地hosts中配置域名解析
        String url = "https://zhaoxiaobin.net:24000/hello";
...
//        SSLContext sslContext = SSLContexts.custom().loadKeyMaterial(keyStore, p12Pwd.toCharArray()).build();
    ...
    @RequestMapping("/httpsMutualAuthByHutool42")
    public String httpsMutualAuthByHutool42() throws Exception {
        // 客户端p12证书
        String p12Path = "/certificates/client/ningbolaw.com.p12";
        // 客户端p12证书密码
        String p12Pwd = "123456";
