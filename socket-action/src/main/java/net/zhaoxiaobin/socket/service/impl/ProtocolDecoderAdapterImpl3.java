 ...
 */
@Service
public class ProtocolDecoderAdapterImpl3 implements IProtocolDecoderAdapter {
    private static final Logger logger = LoggerFactory.getLogger(ProtocolDecoderAdapterImpl3.class);
