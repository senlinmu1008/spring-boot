...
import com.zxb.libai.domain.BodyEntity;
import com.zxb.libai.domain.DetailEntity;
import com.zxb.libai.domain.HeadEntity;
...
/**
 * @author zhaoxb
 * @date 2020/08/22 9:48 下午
 */
public class GenerateByXstream {
    private String xmlHead = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n";

    @Test
    public void testGenerateByXstream() {
        ...
        String xml = xStream.toXML(messageEntity);
